...
PHONE_DUMMY_FILE="import/A54_Dummy.stl";
...
CASE_SLEEVE_ROUNDING_RADIUS=3; // Corner radius of the sleve part of the case.
CASE_ROUNDING_RADIUS=3; // Corner radius of the case.
